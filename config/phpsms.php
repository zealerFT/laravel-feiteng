...
return [
    ...
    'agents' => [
        ...
        'YunPian' => [
            //用户唯一标识，必须
            'apikey' => env('YUN_PIAN_API_KEY','your api key'),
        ],
        ...
        'Alidayu' => [
            //请求地址
            //'sendUrl' => 'http://ecs.aliyuncs.com/',
            'sendUrl' => 'https://eco.taobao.com/router/rest',

            //淘宝开放平台中，对应阿里大鱼短信应用的App Key
            'appKey' => env('ALI_DAYU_APP_KEY','your app key'),

            //淘宝开放平台中，对应阿里大鱼短信应用的App Secret
            'secretKey' => env('ALI_DAYU_SECRET_KEY','your secret key'),

            //短信签名，传入的短信签名必须是在阿里大鱼“管理中心-短信签名管理”中的可用签名
            'smsFreeSignName' => env('ALI_DAYU_SIGN_NAME','your sms free sign name'),
