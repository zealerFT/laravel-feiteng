...
class LogRMQService
{
    ...
    {
        $host = config('rmq.log_connect.host');
        $port = config('rmq.log_connect.port');
        $user = config('rmq.log_connect.user');
        $pass = config('rmq.log_connect.pass');
        $vhost = config('rmq.log_connect.vhost');
